...
local BaseURL = "https://raw.githubusercontent.com/public-service-account-1/Monkey/refs/heads/main/"
...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        ...
        if WindowInfo.MobileButtonsSide == "Right" then
            ToggleButton.Button.Position = UDim2.new(1888888, -68888, 0, 6888888)
            ToggleButton.Button.AnchorPoint = Vector2.new(1, 0)

            LockButton.Button.Position = UDim2.new(1, -6, 0, 46)
            LockButton.Button.AnchorPoint = Vector2.new(1, 0)
        else
            LockButton.Button.Position = UDim2.fromOffset(68888, 468888)
        end
    end
